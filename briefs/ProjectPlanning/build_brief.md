...
### Inspiration
Visual references and source material live in the `inspo` folder and `visual_sources.md`.
...
- `typography.md`, `grid.md`, and `spacing.md` define the visual system.
...
All layout, spacing, and typography must follow the systems defined in:

- `typography.md`
- `grid.md`
- `spacing.md`

Do not introduce arbitrary spacing values, font sizes, or layout measurements outside these systems.
...
Store must inherit the visual system already established rather than introducing a separate storefront interface.
...
- The top navigation floats over hero imagery when present but must remain readable and stable across all screen sizes.
